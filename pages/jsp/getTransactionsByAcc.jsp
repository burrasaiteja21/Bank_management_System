...
<body>
    ...
    <h2 style="text-align: center;">Transactions list for given account number</h2>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            <%
                // Get transactions list from request
            ...
            %>
                        <tr>
                            ...
                            <td class="account from"><%= transaction.getFromAccount() %></td>
                            <td class="account to"><%= transaction.getToAccount() %></td>
